...
struct BaseTurnSnapshot {
    ...
    minerals: i32,
    energy: i32,
    local_military_pressure: i32,
    local_psi_pressure: i32,
    trade_links: usize,
    convoy_usage: usize,
    logistics_stress: i32,
    governor_mode: GovernorMode,
    recommended_governor_mode: GovernorMode,
    first_logistics_plan_item: Option<ProductionItem>,
}

#[derive(Clone, Copy, PartialEq, Eq)]
enum CommandCenterActivationSource {
    Switched,
    Promoted,
}

#[derive(Clone, Copy, Default)]
struct CommandCenterSwitchHistory {
    switch_to_command_center_count: usize,
    switched_away_after_command_center: bool,
}
...
struct RunSummary {
    ...
    command_center_scrap_low_yield_bases: usize,
    command_center_scrap_mid_yield_bases: usize,
    command_center_scrap_high_yield_bases: usize,
    command_center_scrap_safe_bases: usize,
    command_center_scrap_pressured_bases: usize,
    command_center_scrap_isolated_bases: usize,
    command_center_scrap_linked_bases: usize,
    command_center_scrap_without_convoy_usage: usize,
    command_center_scrap_with_convoy_usage: usize,
    ...
    command_center_scrap_balanced_governed: usize,
    command_center_scrap_economy_governed: usize,
    command_center_scrap_other_governed: usize,
    command_center_scrap_off_governed: usize,
    command_center_scrap_defense_governed: usize,
    command_center_scrap_recovery_governed: usize,
    command_center_scrap_residual_governed: usize,
    command_center_scrap_off_plan_freight_depot: usize,
    command_center_scrap_off_plan_transit_hub: usize,
    command_center_scrap_off_plan_patrol_grid: usize,
    command_center_scrap_off_plan_other: usize,
    command_center_scrap_off_plan_command_center: usize,
    command_center_scrap_off_plan_trade_exchange: usize,
    command_center_scrap_off_plan_field_hospital: usize,
    command_center_scrap_off_plan_escort_speeder: usize,
    command_center_scrap_off_plan_network_node: usize,
    command_center_scrap_off_plan_forward_depot: usize,
    command_center_scrap_off_plan_sensor_array: usize,
    command_center_scrap_off_plan_none: usize,
    command_center_scrap_while_building_command_center: usize,
    ...
    command_center_scrap_active_switched: usize,
    command_center_scrap_active_promoted: usize,
    command_center_scrap_active_unknown: usize,
    ...
    command_center_scrap_switched_single_cycle: usize,
    command_center_scrap_switched_multi_cycle: usize,
    command_center_scrap_switched_stayed_on_command_center: usize,
    command_center_scrap_switched_away_and_back: usize,
    command_center_scrap_repeat_rebuild: usize,
    command_center_scrap_first_attempt: usize,
    command_center_scrap_recent_rebuild: usize,
    command_center_scrap_mid_rebuild: usize,
    command_center_scrap_late_rebuild: usize,
    command_center_scrap_no_prior_scrap: usize,
...
fn run() -> Result<(), String> {
    ...
    let mut total_command_center_scrap_low_yield_bases = 0usize;
    let mut total_command_center_scrap_mid_yield_bases = 0usize;
    let mut total_command_center_scrap_high_yield_bases = 0usize;
    let mut total_command_center_scrap_safe_bases = 0usize;
    let mut total_command_center_scrap_pressured_bases = 0usize;
    let mut total_command_center_scrap_isolated_bases = 0usize;
    let mut total_command_center_scrap_linked_bases = 0usize;
    let mut total_command_center_scrap_without_convoy_usage = 0usize;
    let mut total_command_center_scrap_with_convoy_usage = 0usize;
    ...
    let mut total_command_center_scrap_balanced_governed = 0usize;
    let mut total_command_center_scrap_economy_governed = 0usize;
    let mut total_command_center_scrap_other_governed = 0usize;
    let mut total_command_center_scrap_off_governed = 0usize;
    let mut total_command_center_scrap_defense_governed = 0usize;
    let mut total_command_center_scrap_recovery_governed = 0usize;
    let mut total_command_center_scrap_residual_governed = 0usize;
    let mut total_command_center_scrap_off_plan_freight_depot = 0usize;
    let mut total_command_center_scrap_off_plan_transit_hub = 0usize;
    let mut total_command_center_scrap_off_plan_patrol_grid = 0usize;
    let mut total_command_center_scrap_off_plan_other = 0usize;
    let mut total_command_center_scrap_off_plan_command_center = 0usize;
    let mut total_command_center_scrap_off_plan_trade_exchange = 0usize;
    let mut total_command_center_scrap_off_plan_field_hospital = 0usize;
    let mut total_command_center_scrap_off_plan_escort_speeder = 0usize;
    let mut total_command_center_scrap_off_plan_network_node = 0usize;
    let mut total_command_center_scrap_off_plan_forward_depot = 0usize;
    let mut total_command_center_scrap_off_plan_sensor_array = 0usize;
    let mut total_command_center_scrap_off_plan_none = 0usize;
    let mut total_command_center_scrap_while_building_command_center = 0usize;
    ...
    let mut total_command_center_scrap_active_switched = 0usize;
    let mut total_command_center_scrap_active_promoted = 0usize;
    let mut total_command_center_scrap_active_unknown = 0usize;
    ...
    let mut total_command_center_scrap_switched_single_cycle = 0usize;
    let mut total_command_center_scrap_switched_multi_cycle = 0usize;
    let mut total_command_center_scrap_switched_stayed_on_command_center = 0usize;
    let mut total_command_center_scrap_switched_away_and_back = 0usize;
    let mut total_command_center_scrap_repeat_rebuild = 0usize;
    let mut total_command_center_scrap_first_attempt = 0usize;
    let mut total_command_center_scrap_recent_rebuild = 0usize;
    let mut total_command_center_scrap_mid_rebuild = 0usize;
    let mut total_command_center_scrap_late_rebuild = 0usize;
    let mut total_command_center_scrap_no_prior_scrap = 0usize;
    ...
    for offset in 0..config.count {
        ...
        total_command_center_scrap_linked_bases += summary.command_center_scrap_linked_bases;
        total_command_center_scrap_without_convoy_usage +=
            summary.command_center_scrap_without_convoy_usage;
        total_command_center_scrap_with_convoy_usage +=
            summary.command_center_scrap_with_convoy_usage;
        ...
        total_command_center_scrap_balanced_governed +=
        ...
        total_command_center_scrap_recovery_governed +=
            summary.command_center_scrap_recovery_governed;
        total_command_center_scrap_residual_governed +=
            summary.command_center_scrap_residual_governed;
        total_command_center_scrap_off_plan_freight_depot +=
            summary.command_center_scrap_off_plan_freight_depot;
        total_command_center_scrap_off_plan_transit_hub +=
        ...
        total_command_center_scrap_off_plan_trade_exchange +=
            summary.command_center_scrap_off_plan_trade_exchange;
        total_command_center_scrap_off_plan_field_hospital +=
            summary.command_center_scrap_off_plan_field_hospital;
        total_command_center_scrap_off_plan_escort_speeder +=
            summary.command_center_scrap_off_plan_escort_speeder;
        total_command_center_scrap_off_plan_network_node +=
            summary.command_center_scrap_off_plan_network_node;
        total_command_center_scrap_off_plan_forward_depot +=
        ...
        total_command_center_scrap_switched_single_cycle +=
            summary.command_center_scrap_switched_single_cycle;
        total_command_center_scrap_switched_multi_cycle +=
            summary.command_center_scrap_switched_multi_cycle;
        total_command_center_scrap_switched_stayed_on_command_center +=
        ...
        println!(
            ...
            summary.command_center_scrap_with_transit_hub,
            summary.command_center_scrap_with_hologram_theatre,
            summary.command_center_scrap_small_bases,
            summary.command_center_scrap_mid_bases,
            summary.command_center_scrap_large_bases,
            summary.command_center_scrap_low_yield_bases,
            summary.command_center_scrap_mid_yield_bases,
            summary.command_center_scrap_high_yield_bases,
            summary.command_center_scrap_safe_bases,
            summary.command_center_scrap_pressured_bases,
            summary.command_center_scrap_isolated_bases,
            summary.command_center_scrap_linked_bases,
            summary.command_center_scrap_without_convoy_usage,
            summary.command_center_scrap_with_convoy_usage,
            summary.command_center_scrap_low_logistics_stress,
            summary.command_center_scrap_mid_logistics_stress,
    ...
    println!(
        "aggregate | terminal {} / {} | raids {} | combats {} | captures {} | wars {} | p off {}/{} | ai off {}/{} | bankruptcies {} fac {} unit {} scr {}/{}/{}/{}/{}/{}/{} ccs {}/{}/{} cce {}/{} cct {}/{} ccx {}/{}/{} ccp {}/{}/{} ccy {}/{}/{} ccr {}/{} ccl {}/{} ccv {}/{} ccg {}/{}/{} ccm {}/{} ccrg {}/{} ccmd {}/{}/{} cco {}/{}/{}/{} ccpn {}/{}/{}/{} ccpo {}/{}/{}/{}/{} ccox {}/{}/{} ccpr {}/{}/{}/{} ccas {}/{}/{} ccsr {}/{}/{} ccsm {}/{} ccsb {}/{} ccre {}/{} ccrd {}/{}/{}/{} top {} em {}/{} | famines {} | starvation {} | support {} | player low-expansion {} | ai low-expansion {} | player zero-unit {} | ai zero-unit {}",
        terminal_runs,
        config.count,
        total_raids,
        total_combats,
        ...
        total_command_center_scrap_with_transit_hub,
        total_command_center_scrap_with_hologram_theatre,
        total_command_center_scrap_small_bases,
        total_command_center_scrap_mid_bases,
        total_command_center_scrap_large_bases,
        total_command_center_scrap_low_yield_bases,
        total_command_center_scrap_mid_yield_bases,
        total_command_center_scrap_high_yield_bases,
        total_command_center_scrap_safe_bases,
        total_command_center_scrap_pressured_bases,
        total_command_center_scrap_isolated_bases,
        total_command_center_scrap_linked_bases,
        total_command_center_scrap_without_convoy_usage,
        total_command_center_scrap_with_convoy_usage,
        total_command_center_scrap_low_logistics_stress,
        total_command_center_scrap_mid_logistics_stress,
...
fn run_seed(seed: u32, config: &Config) -> RunSummary {
    ...
    let mut command_center_scrap_low_yield_bases = 0usize;
    let mut command_center_scrap_mid_yield_bases = 0usize;
    let mut command_center_scrap_high_yield_bases = 0usize;
    let mut command_center_scrap_safe_bases = 0usize;
    let mut command_center_scrap_pressured_bases = 0usize;
    let mut command_center_scrap_isolated_bases = 0usize;
    let mut command_center_scrap_linked_bases = 0usize;
    let mut command_center_scrap_without_convoy_usage = 0usize;
    let mut command_center_scrap_with_convoy_usage = 0usize;
    ...
    let mut command_center_scrap_balanced_governed = 0usize;
    let mut command_center_scrap_economy_governed = 0usize;
    let mut command_center_scrap_other_governed = 0usize;
    let mut command_center_scrap_off_governed = 0usize;
    let mut command_center_scrap_defense_governed = 0usize;
    let mut command_center_scrap_recovery_governed = 0usize;
    let mut command_center_scrap_residual_governed = 0usize;
    let mut command_center_scrap_off_plan_freight_depot = 0usize;
    let mut command_center_scrap_off_plan_transit_hub = 0usize;
    let mut command_center_scrap_off_plan_patrol_grid = 0usize;
    let mut command_center_scrap_off_plan_other = 0usize;
    let mut command_center_scrap_off_plan_command_center = 0usize;
    let mut command_center_scrap_off_plan_trade_exchange = 0usize;
    let mut command_center_scrap_off_plan_field_hospital = 0usize;
    let mut command_center_scrap_off_plan_escort_speeder = 0usize;
    let mut command_center_scrap_off_plan_network_node = 0usize;
    let mut command_center_scrap_off_plan_forward_depot = 0usize;
    let mut command_center_scrap_off_plan_sensor_array = 0usize;
    let mut command_center_scrap_off_plan_none = 0usize;
    let mut command_center_scrap_while_building_command_center = 0usize;
    ...
    let mut command_center_scrap_active_switched = 0usize;
    let mut command_center_scrap_active_promoted = 0usize;
    let mut command_center_scrap_active_unknown = 0usize;
    ...
    let mut command_center_scrap_switched_single_cycle = 0usize;
    let mut command_center_scrap_switched_multi_cycle = 0usize;
    let mut command_center_scrap_switched_stayed_on_command_center = 0usize;
    let mut command_center_scrap_switched_away_and_back = 0usize;
    let mut command_center_scrap_repeat_rebuild = 0usize;
    let mut command_center_scrap_first_attempt = 0usize;
    let mut command_center_scrap_recent_rebuild = 0usize;
    let mut command_center_scrap_mid_rebuild = 0usize;
    let mut command_center_scrap_late_rebuild = 0usize;
    let mut command_center_scrap_no_prior_scrap = 0usize;
                ...
                if entry.message.contains("scrapped") {
                    ...
                    if entry.message.contains("CommandCenter") {
                        if let Some((owner, base_name)) = bankruptcy_base_name(entry.message.as_str(), &game)
                        {
                            ...
                            let last_command_center_scrap_turn = if owner == game.player_owner() {
                                &mut player_last_command_center_scrap_turn
                            } else {
                                &mut ai_last_command_center_scrap_turn
                            };
                            let previous_scrap_turn = last_command_center_scrap_turn
                                .get(base_name)
                                .copied()
                                .unwrap_or(0);
                                ...
                                snapshots.iter().find(|snapshot| snapshot.base_name == base_name)
                            {
                                ...
                                match snapshot.population {
                                    i32::MIN..=2 => command_center_scrap_small_bases += 1,
                                    3..=4 => command_center_scrap_mid_bases += 1,
                                    _ => command_center_scrap_large_bases += 1,
                                }
                                let local_yield = snapshot.minerals + snapshot.energy;
                                match local_yield {
                                    i32::MIN..=3 => command_center_scrap_low_yield_bases += 1,
                                    4..=6 => command_center_scrap_mid_yield_bases += 1,
                                    _ => command_center_scrap_high_yield_bases += 1,
                                }
                                if snapshot.local_military_pressure <= 0
                                    && snapshot.local_psi_pressure <= 0
                                {
                                    command_center_scrap_safe_bases += 1;
                                } else {
                                    command_center_scrap_pressured_bases += 1;
                                }
                                if snapshot.trade_links == 0 {
                                    command_center_scrap_isolated_bases += 1;
                                } else {
                                    command_center_scrap_linked_bases += 1;
                                }
                                if snapshot.convoy_usage == 0 {
                                    command_center_scrap_without_convoy_usage += 1;
                                } else {
                                    command_center_scrap_with_convoy_usage += 1;
                                }
                                match snapshot.logistics_stress {
                                    i32::MIN..=0 => command_center_scrap_low_logistics_stress += 1,
                                ...
                                match snapshot.governor_mode {
                                    GovernorMode::Balanced => {
                                        command_center_scrap_balanced_governed += 1;
                                    }
                                    GovernorMode::Economy => {
                                        command_center_scrap_economy_governed += 1;
                                    }
                                    _ => command_center_scrap_other_governed += 1,
                                }
                                match snapshot.governor_mode {
                                    GovernorMode::Off => command_center_scrap_off_governed += 1,
                                    GovernorMode::Defense => {
                                        command_center_scrap_defense_governed += 1;
                                    }
                                    GovernorMode::Recovery => {
                                        command_center_scrap_recovery_governed += 1;
                                    }
                                    GovernorMode::Balanced
                                    | GovernorMode::Economy
                                    | GovernorMode::Logistics => {}
                                    _ => command_center_scrap_residual_governed += 1,
                                }
                                if snapshot.governor_mode == GovernorMode::Off {
                                    match snapshot.first_logistics_plan_item {
                                        Some(ProductionItem::FreightDepot) => {
                                            command_center_scrap_off_plan_freight_depot += 1;
                                        }
                                        Some(ProductionItem::TransitHub) => {
                                            command_center_scrap_off_plan_transit_hub += 1;
                                        }
                                        Some(ProductionItem::PatrolGrid) => {
                                            command_center_scrap_off_plan_patrol_grid += 1;
                                        }
                                        Some(ProductionItem::CommandCenter) => {
                                            command_center_scrap_off_plan_command_center += 1;
                                        }
                                        Some(ProductionItem::TradeExchange) => {
                                            command_center_scrap_off_plan_trade_exchange += 1;
                                        }
                                        Some(ProductionItem::FieldHospital) => {
                                            command_center_scrap_off_plan_field_hospital += 1;
                                        }
                                        Some(ProductionItem::EscortSpeeder) => {
                                            command_center_scrap_off_plan_escort_speeder += 1;
                                        }
                                        Some(ProductionItem::NetworkNode) => {
                                            command_center_scrap_off_plan_network_node += 1;
                                        }
                                        Some(ProductionItem::ForwardDepot) => {
                                            command_center_scrap_off_plan_forward_depot += 1;
                                        }
                                        Some(ProductionItem::SensorArray) => {
                                            command_center_scrap_off_plan_sensor_array += 1;
                                        }
                                        None => {
                                            command_center_scrap_off_plan_none += 1;
                                        }
                                        Some(_) => {
                                            command_center_scrap_off_plan_other += 1;
                                        }
                                    }
                                }
                                match snapshot.current_production {
                                    ProductionItem::CommandCenter => {
                                        ...
                                        match base_last_command_center_activation_source(
                                            &game,
                                            &snapshot.base_name,
                                        ) {
                                            Some(CommandCenterActivationSource::Switched) => {
                                                command_center_scrap_active_switched += 1;
                                                let switch_history = command_center_switch_history_since(
                                                    &game,
                                                    &snapshot.base_name,
                                                    previous_scrap_turn,
                                                    completed_turns,
                                                );
                                                if switch_history.switch_to_command_center_count <= 1 {
                                                    command_center_scrap_switched_single_cycle += 1;
                                                } else {
                                                    command_center_scrap_switched_multi_cycle += 1;
                                                }
                                                if switch_history.switched_away_after_command_center {
                                                ...
                                                match game
                                                    .bases_for(owner)
                                                    .into_iter()
                                                    .find(|base| base.name == snapshot.base_name)
                                                    .and_then(|base| {
                                                        command_center_choice_source_for_base(
                                                            &game, base.id, owner,
                                                        )
                                                    }) {
                                                    Some(
                                                        AiCommandCenterChoiceSource::UrgentSupportRelief,
                                                    ) => {
                                                        command_center_scrap_switched_urgent_relief += 1;
                                                    }
                                                    Some(
                                                        AiCommandCenterChoiceSource::GenericMineralFallback,
                                                    ) => {
                                                        command_center_scrap_switched_generic_fallback += 1;
                                                    }
                                                    None => {
                                                        command_center_scrap_switched_other_source += 1;
                                                    }
                                                }
                                            }
                                            Some(CommandCenterActivationSource::Promoted) => {
                                                command_center_scrap_active_promoted += 1;
                                            }
                                            None => {
                                                command_center_scrap_active_unknown += 1;
                                            }
                                        }
                                    }
                                    ProductionItem::FreightDepot => {
                                        command_center_scrap_while_building_freight_depot += 1;
                                    }
                                    ProductionItem::HologramTheatre => {
                                        command_center_scrap_while_building_hologram_theatre += 1;
                                    }
                                    _ => {
                                ...
                                match last_command_center_scrap_turn.get(&snapshot.base_name).copied() {
                                    Some(previous_turn) => {
                                        ...
                                        if gap <= 5 {
                                            command_center_scrap_recent_rebuild += 1;
                                        } else if gap <= 15 {
                                            command_center_scrap_mid_rebuild += 1;
                                        } else {
                                            command_center_scrap_late_rebuild += 1;
                                        }
                                    }
                                    None => {
                                        command_center_scrap_no_prior_scrap += 1;
                                    }
                                }
                                last_command_center_scrap_turn
                                    .insert(snapshot.base_name.clone(), completed_turns);
                            }
                        }
                    }
    ...
    RunSummary {
        ...
        command_center_scrap_low_yield_bases,
        command_center_scrap_mid_yield_bases,
        command_center_scrap_high_yield_bases,
        command_center_scrap_safe_bases,
        command_center_scrap_pressured_bases,
        command_center_scrap_isolated_bases,
        command_center_scrap_linked_bases,
        command_center_scrap_without_convoy_usage,
        command_center_scrap_with_convoy_usage,
        ...
        command_center_scrap_balanced_governed,
        command_center_scrap_economy_governed,
        command_center_scrap_other_governed,
        command_center_scrap_off_governed,
        command_center_scrap_defense_governed,
        command_center_scrap_recovery_governed,
        command_center_scrap_residual_governed,
        command_center_scrap_off_plan_freight_depot,
        command_center_scrap_off_plan_transit_hub,
        command_center_scrap_off_plan_patrol_grid,
        command_center_scrap_off_plan_other,
        command_center_scrap_off_plan_command_center,
        command_center_scrap_off_plan_trade_exchange,
        command_center_scrap_off_plan_field_hospital,
        command_center_scrap_off_plan_escort_speeder,
        command_center_scrap_off_plan_network_node,
        command_center_scrap_off_plan_forward_depot,
        command_center_scrap_off_plan_sensor_array,
        command_center_scrap_off_plan_none,
        command_center_scrap_while_building_command_center,
        ...
        command_center_scrap_active_switched,
        command_center_scrap_active_promoted,
        command_center_scrap_active_unknown,
        ...
        command_center_scrap_switched_single_cycle,
        command_center_scrap_switched_multi_cycle,
        command_center_scrap_switched_stayed_on_command_center,
        command_center_scrap_switched_away_and_back,
        command_center_scrap_repeat_rebuild,
        command_center_scrap_first_attempt,
        command_center_scrap_recent_rebuild,
        command_center_scrap_mid_rebuild,
        command_center_scrap_late_rebuild,
        command_center_scrap_no_prior_scrap,
...
fn base_last_command_center_activation_source(
    game: &GameState,
    base_name: &str,
) -> Option<CommandCenterActivationSource> {
    game.log.iter().rev().find_map(|entry| {
        if !entry.message.contains(base_name) {
            return None;
        }
        if entry
            .message
            .contains("switched production to Command Center")
        {
            return Some(CommandCenterActivationSource::Switched);
        }
        if entry
            .message
            .contains("promoted Command Center to active production")
        {
            return Some(CommandCenterActivationSource::Promoted);
        }
        None
    })
}

fn command_center_switch_history_since(
    game: &GameState,
    base_name: &str,
    after_turn: usize,
    through_turn: usize,
) -> CommandCenterSwitchHistory {
    let mut history = CommandCenterSwitchHistory::default();
    let mut saw_command_center_switch = false;
    for entry in game.log.iter().filter(|entry| {
        let turn = entry.turn.max(0) as usize;
        turn > after_turn && turn <= through_turn && entry.message.contains(base_name)
    }) {
        if entry.message.contains("switched production to Command Center") {
            history.switch_to_command_center_count += 1;
            saw_command_center_switch = true;
            continue;
        }
        if saw_command_center_switch && entry.message.contains("switched production to ") {
            history.switched_away_after_command_center = true;
            saw_command_center_switch = false;
        }
    }
    history
}
