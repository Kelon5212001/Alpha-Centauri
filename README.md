...
- Sprint O fixed the seed-`7` Sparta collapse, and the current verified turn-100 result is `Gaia 5 bases / 28 units` and `Sparta 4 bases / 14 units`
...
```text
Turn 100 | Mission Year 2201 | routes 11 | projects 0
  Gaia's Stepdaughters -> bases 5, units 28, energy 11, known techs 15, research Secrets of Planet 130/300
  Spartan Federation -> bases 4, units 14, energy 107, known techs 11, research Orbital Mechanics 91/100
...
```text
aggregate | terminal 0 / 10 | bankruptcies 0 | famines 0 | starvation 0 | support 0 | player low-expansion 0 | ai low-expansion 0 | player zero-unit 0 | ai zero-unit 0
```
...
- the remaining sweep weakness is no longer basic survival or expansion; it is now about making the midgame politically and militarily interesting
